                    ...
                    <form action="{{ route('dashboard.clients.index') }}" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                @if (auth()->user()->hasPermission('create_clientssss'))
                                   ...
                                   {{-- <td>
                                    ...
                                    <td>
                                        @if (auth()->user()->hasPermission('update_clients'))
                                          @if($client->enable==1)
                                            <a href="{{ route('dashboard.clients.edit', $client->id) }}" class="btn btn-danger btn-sm"><i class="fa fa-edit"></i> @lang('site.disable')</a>
                                       @else
                                       
                                        <a href="{{ route('dashboard.clients.edit', $client->id) }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> @lang('site.enable')</a>
                                       @endif
                                        @else
