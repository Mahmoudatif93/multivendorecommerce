                    ...
                    @if ($products->count() > 0)
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <th>@lang('site.pricetext_ar')</th>
                        
                                <th>@lang('site.availableAmount')</th>

                                <th>@lang('site.availableAmountText_ar')</th>
                                <th>@lang('site.availableAmountText_en') </th>
                                        <th>@lang('site.type_ar') </th>
                                <th>@lang('site.productprovider')</th>
                            ...
                            @foreach ($products as $index=>$product)
                                <tr>
                                    ...
                                    <td><img src="{{ asset('uploads/'.$product->image) }}" style="width: 100px"  class="img-thumbnail" alt=""></td>
                                    <td>{{ $product->price }}</td>
                                    <td>{{ $product->pricetext_ar }}</td>
                                   
                                    <td>{{ $product->availableAmount }}</td>
                                    <td>{{ $product->availableAmountText_ar }}</td>
                                    <td>{{ $product->availableAmountText_en }}</td>
                                    <td>{{ $product->type_ar }}</td>
                                    <td>{{ $product->ProductProvider->name_ar }}</td>
                                    <td>
