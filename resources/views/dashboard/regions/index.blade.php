        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="margin-bottom: 15px">@lang('site.regions') <small>{{ $regions->total() }}</small></h3>
                    ...
                    @if ($regions->count() > 0)
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <th>@lang('site.city_name_ar')</th>
                                <th>@lang('site.city_name_en')</th>
                            ...
                            @foreach ($regions as $index=>$region)
                                <tr>
                                    ...
                                    <td>{{ $region->cities->name_ar }}</td>
                                    <td>{{ $region->cities->name_en }}</td>
                                    <td>
