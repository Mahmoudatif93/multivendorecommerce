<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        @if (auth()->user()->hasPermission('read_cities'))
            <li><a href="{{ route('dashboard.bussinessType.index') }}"><i class="fa fa-th"></i><span>@lang('site.bussinessType')</span></a></li>
        @endif
        @if (auth()->user()->hasPermission('read_cities'))
                <li><a href="{{ route('dashboard.cities.index') }}"><i class="fa fa-th"></i><span>@lang('site.cities')</span></a></li>
            @endif
         ...
         @if (auth()->user()->hasPermission('read_categories'))
            ...
            @endif
            @if (auth()->user()->hasPermission('read_productprovider'))
            <li><a href="{{ route('dashboard.productprovider.index') }}"><i class="fa fa-th"></i><span>@lang('site.productprovider')</span></a></li>
        @endif
        ...
        @endif
        @if (auth()->user()->hasPermission('read_orders'))
            <li><a href="{{ route('dashboard.complaints.index') }}"><i class="fa fa-th"></i><span>@lang('site.complaints')</span></a></li>
        @endif
         @if (auth()->user()->hasPermission('read_orders'))
            <li><a href="{{ route('dashboard.bankbalance.index') }}"><i class="fa fa-th"></i><span>@lang('site.bankbalance')</span></a></li>
        @endif
